...
class PublicSubmissions extends StatefulWidget {
  final String handle;
  ...
  @override
  State<PublicSubmissions> createState() => _SubmissionsState();
}

class _SubmissionsState extends State<PublicSubmissions> {
  late String handle;
